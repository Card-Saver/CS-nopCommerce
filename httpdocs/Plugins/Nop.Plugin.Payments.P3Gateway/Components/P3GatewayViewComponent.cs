...
namespace Nop.Plugin.Payments.P3Gateway.Components
{
    [ViewComponent(Name = "P3Gateway")]
    public class P3GatewayViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            if (Request.Method != WebRequestMethods.Http.Get)
            {
                ...
                var selectedCcType = model.CreditCardTypes.FirstOrDefault(x =>
                    x.Value.Equals(form["CreditCardType"], StringComparison.InvariantCultureIgnoreCase));
            ...
            return View("~/Plugins/Payments.P3Gateway/Views/PaymentInfo.cshtml", model);
        }
    }
}